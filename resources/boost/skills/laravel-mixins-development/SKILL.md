...
description: Application integration guidance for protonemedia/laravel-mixins.
license: MIT
metadata:
  author: ProtoneMedia
---
...
## Overview
Use `protonemedia/laravel-mixins.` in a Laravel application.
...
- Activate when code references `protonemedia/laravel-mixins.` classes, facades, config, or documented features.
